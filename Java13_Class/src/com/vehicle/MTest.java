...
public class MTest {
	...
	public static void main(String[] args) {
		...
		myCar.accelPedal();								//속도가 15올라갑니다.
		myCar.accelPedal();								//속도가 15올라갑니다.
		System.out.println(myCar);						//현재속도는 30입니다.
		...
		myCar = new SportsCar("빨간색");				//출력:빨간색 스포츠카 생성
		myCar.accelPedal();								//속도가 20올라갑니다.
		myCar.accelPedal();								//속도가 20올라갑니다.
		System.out.println(myCar);						//현재속도는 40입니다.
